...
ALTER TABLE ONLY public.credit_cards
    ALTER COLUMN id SET DEFAULT nextval('public.credit_cards_id_seq'::regclass);


ALTER TABLE ONLY public.order_positions
    ALTER COLUMN id SET DEFAULT nextval('public.order_positions_id_seq'::regclass);
...
ALTER TABLE ONLY public.procurement_positions
    ALTER COLUMN id SET DEFAULT nextval('public.procurement_positions_id_seq'::regclass);


ALTER TABLE ONLY public.procurements
    ALTER COLUMN id SET DEFAULT nextval('public.procurements_id_seq'::regclass);

ALTER TABLE ONLY public.product_categories
    ALTER COLUMN id SET DEFAULT nextval('public.product_categories_id_seq'::regclass);

ALTER TABLE ONLY public.products
    ALTER COLUMN id SET DEFAULT nextval('public.products_id_seq'::regclass);

ALTER TABLE ONLY public.recipes
    ALTER COLUMN id SET DEFAULT nextval('public.recipes_id_seq'::regclass);

ALTER TABLE ONLY public.roles
    ALTER COLUMN id SET DEFAULT nextval('public.roles_id_seq'::regclass);

ALTER TABLE ONLY public.stock_positions
    ALTER COLUMN id SET DEFAULT nextval('public.stock_positions_id_seq'::regclass);
